...
public class AddFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(AddFriendsActivity.this, android.R.layout.simple_list_item_1, myArrayList);
...
//                   String value = dataSnapshot.getValue(String.class);
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(AddFriendsActivity.this, "You sent friend request!", Toast.LENGTH_SHORT).show();
